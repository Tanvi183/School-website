        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Photo Category Box</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header" style="padding: 5px 22px 5px 22px;">
                <h3 class="card-title" style="padding-top: 5px;">CREATE PHOTO CATEGORY</h3>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::open(array('route' => 'photo-category.store','class'=>'form-horizontal','files'=>true)) !!}
                <div class="card-body">
