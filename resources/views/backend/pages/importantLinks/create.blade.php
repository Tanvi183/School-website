          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header" style="padding: 5px 22px 5px 22px;">
                <h3 class="card-title" style="padding-top: 5px;">CREATE IMPORTANT LINKS</h3>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::open(array('route' => 'manage-links.store','class'=>'form-horizontal','files'=>true)) !!}
                <div class="card-body">
                    <div class="row offset-1">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {{Form::text('name','',array('class'=>'form-control','id'=>'name','placeholder'=>'Link Name','required'))}}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row offset-1">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {{Form::text('link','',array('class'=>'form-control','id'=>'link','placeholder'=>'Link Url','required'))}}
                                </div>
                            </div>
                        </div>
                    </div>
