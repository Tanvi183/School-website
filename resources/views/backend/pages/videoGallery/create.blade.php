          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header" style="padding: 5px 22px 5px 22px;">
                <h3 class="card-title" style="padding-top: 5px;">CREATE VIDEO GALLERY</h3>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::open(array('route' => 'video-gallery.store','class'=>'form-horizontal','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <div class="row offset-1">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {{Form::text('title','',array('class'=>'form-control','id'=>'title','placeholder'=>'title','required'))}}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row offset-1">
                        <div class="col-md-12">
                            <div class="form-group row">
                                {{Form::label('url', 'Video Url : ', array('class' => 'col-md-2 control-label'))}}
                                <div class="col-sm-10">
                                    {{Form::text('url','',array('class'=>'form-control','id'=>'url','placeholder'=>'Video Url','required'))}}
                                </div>
                            </div>
                        </div>
                    </div>
